...
# Optional path to the internal CA bundle used to verify the valuation API's TLS certificate.
...
def fetch_vehicle_valuation(vin):
    ...
    resp = requests.get(
        ...
        verify=VALUATION_API_CA_BUNDLE if VALUATION_API_CA_BUNDLE else True,
        timeout=10,
    )
