...
# Optional path to the internal CA bundle used to verify the valuation API certificate
...
def extract_vehicle_sales_data(region_filter=None):
    ...
    for idx, row in df.iterrows():
        try:
            ...
            logger.warning("Valuation lookup failed for VIN index %s", idx, exc_info=True)
