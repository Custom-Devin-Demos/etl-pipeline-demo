...
# Path to the CA bundle used to verify the valuation API certificate. Set to a
# bundle containing the internal CA when calling an internally issued endpoint.
